...
class ApiConstants {
  ...
  static String get baseUrl {
    if (kIsWeb) {
      return 'http://192.168.6.156:1444/api';
  ...
  static String get frontendUrl {
    if (kIsWeb) {
      return 'http://192.168.6.156:3000';
    } else if (Platform.isAndroid) {
      return 'http://192.168.6.156:3000';
    } else if (Platform.isIOS) {
      return 'http://192.168.6.156:3000';
  ...
  static const String expressInterestEndpoint = '/draft-matches/{id}/express-interest';
  static const String withdrawInterestEndpoint = '/draft-matches/{id}/withdraw-interest';
  static const String acceptUserEndpoint = '/draft-matches/{id}/accept/{userId}';
  static const String rejectUserEndpoint = '/draft-matches/{id}/reject/{userId}';
  static const String convertToMatchEndpoint = '/draft-matches/{id}/convert';
  static const String updateDraftMatchEndpoint = '/draft-matches/{id}';
  static const String interestedUsersEndpoint = '/draft-matches/{id}/interested-users';
  static const String initiateDraftMatchBookingEndpoint = '/draft-matches/{id}/initiate-booking';
  static const String completeDraftMatchBookingEndpoint = '/booking/from-draft/{draftMatchId}';
  static const String rankedDraftMatchesEndpoint = '/draft-matches/ranked';
  static const String draftMatchesWithUserInfoEndpoint = '/draft-matches/with-user-info';
  ...
  static const String tournamentReceiptEndpoint = '/tournament/receipt/{tournamentId}';
  static const String tournamentPublicReceiptEndpoint = '/tournament/public-receipt/{tournamentId}';
  
  // Team endpoints
  static const String teamsEndpoint = '/teams';
  static const String teamsByUserEndpoint = '/teams'; // Use query parameter ?userId={userId}
