...
class _PayPalWebViewHandlerState extends State<PayPalWebViewHandler> {
        ...
        ..setNavigationDelegate(
          NavigationDelegate(
            ...
            onPageFinished: (String url) {
              ...
              if (url.contains('192.168.1.14:1444/api/payment/flutter/')) {
                print(
  ...
  void _handleUrlChange(String url) {
    ...
    if (url.contains('192.168.1.14:1444/api/payment/flutter/success')) {
    ...
    if (url.contains('192.168.1.14:1444/api/payment/flutter/error')) {
